#ifndef __EUROPEAN_FWD_START_PUT_H__
#define __EUROPEAN_FWD_START_PUT_H__
...
template<class T>
T european_fwd_start_put_value(const T s, const T k, const T v, const T r, const T b, const T t_a, const T t_b)
{
