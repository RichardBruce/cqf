#ifndef __FIRST_ORDER_RISK_H__
#define __FIRST_ORDER_RISK_H__

#include "risk.h"


/* Bumper for first order volatility risk */
template<class T>
class dvol1_scenario_bumper : public scenario_bumper<T>
{
    public :
        dvol1_scenario_bumper(const T order, const T bump_size = 0.01, 
...
/* Bumper for first order interest rate risk */
template<class T>
class drate1_scenario_bumper : public scenario_bumper<T>
{
    public :
        drate1_scenario_bumper(const T order, const T bump_size = 0.01, 
            const bump_dir_t bump_dir = BI, const bump_style_t bump_style = ADD) 
            : scenario_bumper<T>(order, bump_size, bump_dir, bump_style)
            {  };
...
/* Bumper for first order time risk */
template<class T>
class dtime1_scenario_bumper : public scenario_bumper<T>
{
    public :
        dtime1_scenario_bumper(const T order, const T bump_size = 0.01, 
            const bump_dir_t bump_dir = BI, const bump_style_t bump_style = ADD) 
            : scenario_bumper<T>(order, bump_size, bump_dir, bump_style)
            {  };
...
/* Bumper for first order spot risk */
template<class T>
class dspot1_scenario_bumper : public scenario_bumper<T>
{
    public :
        dspot1_scenario_bumper(const T order, const T bump_size = 0.01, 
            const bump_dir_t bump_dir = BI, const bump_style_t bump_style = ADD) 
            : scenario_bumper<T>(order, bump_size, bump_dir, bump_style)
            {  };
